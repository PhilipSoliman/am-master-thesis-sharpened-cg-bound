...
\begin{problem}[\textbf{High-contrast scalar elliptic problem: strong formulation}]
...
\begin{problem}[\textbf{High-contrast scalar elliptic problem: weak formulation}]
...
\begin{problem}[\textbf{High-contrast scalar elliptic problem: discretized weak formulation}]
...
The problem of solving \cref{eq:elliptic_problem} is now a transformed into a numerical one. That is, we need to solve a linear system of equations to obtain the solution $\mathbf{u}$ to construct our approximate solution
\begin{equation*}
