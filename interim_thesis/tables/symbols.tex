...
\section*{Symbols}
% Table 1: Symbols for the Heterogeneous Elliptic Problem
...
% Table 2: Symbols for the Conjugate Gradient Method
\begin{longtable}{c p{10cm}}
...
% Table 3: Symbols for the Schwarz Preconditioners
\begin{longtable}{c p{10cm}}
...
% Table 4: Symbols related to eigenspectra and CG convergence bounds
\begin{longtable}{c p{10cm}}
