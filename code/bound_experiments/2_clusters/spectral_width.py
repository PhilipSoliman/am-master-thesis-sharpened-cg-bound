...
LEFT_CLUSTER_WIDTH = 1e-8
SPECTRAL_WIDTH_MULTIPLIER = 2

# initial clusters
a_1 = MIN_EIG
b_1 = a_1 + LEFT_CLUSTER_WIDTH
c_1 = (a_1 + b_1) / 2
w_1 = b_1 - a_1
...
for i in range(1, max_i + 1):
    d_ec = normalized_spectral_width * SPECTRAL_WIDTH_MULTIPLIER**i
    b_n_i = c_1 + w_1 * d_ec
    a_n_i = b_n_i / RIGHT_CLUSTER_CONDITION_NUMBER
    left_clusters.append((a_1, b_1))
