...
# Next to that of course the manim_slides documentation https://manim-slides.readthedocs.io/en/latest/ as well as 3Blue1Brown's own manimgl docs https://3b1b.github.io/manim/
...
# esnure hcmsfem does not overwrite CLI args
...
BIBLIOGRAPHY_FILE = get_venv_root() / "defense/bibliography.json"
...
class defense(Slide):
    ...
    def level_3_preconditioning(self):
        ...
        self.update_slide(
            ...
            new_contents=[self.main_question],
            additional_animations=[FadeIn(addendum), MoveToTarget(self.sub_questions)],
            transition_time=2 * self.RUN_TIME,
        )
        # self.main_question.add(addendum)
    ...
    def level_4_two_clusters(self):
        ...
        self.update_slide(
            ...
            subtitle="Predicting Preconditioned CG Performance",
            new_contents=[self.main_question],
            additional_animations=[MoveToTarget(self.sub_questions)],
            transition_time=2 * self.RUN_TIME,
        )
