...
\subsection{Algorithm for multi-cluster CG bound}\label{sec:cg_multi_cluster_bound_algorithm}
...
\begin{algorithm}[H]
    ...
    \begin{algorithmic}[1]
        ...
        \State \textbf{Output:} Generalized CG bound $m_{N_{\text{clusters}}}$
...
\begin{algorithm}[H]
    ...
    \begin{algorithmic}[1]
        ...
        \State $\kappa_l \gets \frac{\lambda_{k^*}}{\lambda_1}$
        \State $\kappa_r \gets \frac{\lambda_n}{\lambda_{k^*+1}}$
        \If{$p < \left\lfloor\frac{\sqrt{\kappa_l}}{2}\ln{\frac{2}{\epsilon}} + 1 \right\rfloor$ and $p < \left\lfloor\sqrt{\frac{\kappa}{\kappa_r}}\log_{\frac{4\kappa}{\kappa_l}}\left(\frac{2}{\epsilon}\right)\right\rfloor$}
