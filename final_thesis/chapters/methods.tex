...
\subsection{Single-eigenvalue and tail clusters}\label{sec:cg_single_eigenvalue_tail_clusters}
...
\begin{algorithm}[H]
    ...
    \begin{algorithmic}[1]
        ...
        \For{$[a_i, b_i] \in \text{clusters}\setminus\text{clusters}_s$}
        ...
        \For{$[a_j, b_j] \in \text{clusters}_{<i}\setminus\text{clusters}_s$} \Comment{$\text{clusters}_{<i}$ = all clusters to the left of $[a_i, b_i]$}
...
\section{Algorithm for sharpened CG bound}\label{sec:cg_iteration_bound_algorithm}
