...
\begin{equation}
    \bar{m}=\left\lceil 1 + \frac{\sqrt{\kappa_r}}{2}\ln\left(\frac{4\kappa}{\kappa_l}\right) + \frac{\sqrt{\kappa_r}}{2}\ln\left(\frac{2}{\epsilon}\right) + \frac{\sqrt{\kappa_l}}{2}\ln\left(\frac{2}{\epsilon}\right) + \frac{\kappa}{2}\ln\left(\frac{4\kappa}{\kappa_l}\right)\ln\left(\frac{2}{\epsilon}\right) \right\rceil.
\end{equation}
Restricting ourselves to the case of a uniform eigenspectrum, i.e. $a<b=c<d$, we can set $\kappa=\kappa_l\kappa_r$, which yields
\[
    1 + \frac{\sqrt{\kappa_r}}{2}\ln\left(4\kappa_r\right) + \left(\right)\ln\left(\frac{2}{\epsilon}\right)
\]
