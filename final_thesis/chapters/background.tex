...
\begin{equation}
  m \geq \left\lceil\log_f\left(\frac{\epsilon}{2}\right)\right\rceil = \textrm{int}\left[\log_f\left(\frac{\epsilon}{2}\right) + 1\right],
...
to write
\[
  \left(\frac{\sqrt{\kappa} - 1}{\sqrt{\kappa} + 1}\right)^{\tilde{m}} \leq \exp \left(-\frac{2\tilde{m}}{\sqrt{\kappa}}\right) \leq \frac{\epsilon}{2},
\]
which can be rearranged to give
\begin{equation}
    m \geq \left\lceil\frac{\sqrt{\kappa}}{2}\ln\left(\frac{2}{\epsilon}\right)\right\rceil = \textrm{int}\left[\frac{\sqrt{\kappa}}{2}\ln\left(\frac{2}{\epsilon}\right) + 1\right].
