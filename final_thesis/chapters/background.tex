...
\begin{fancydef}{Dirichlet-to-Neumann map}{dirichlet_to_neumann_map}
  For any function defined on the interface $u_{\partial\Omega_j}: \delta\Omega_j \mapsto \mathbb{R}$, we consider the Dirichlet-to-Neumann map
  \[
  ...
  \begin{equation}
    \begin{aligned}
      ...
      v                                            & =u_{\partial\Omega_j} & \text { on } \delta\Omega_j,                               \\
...
Notice that the bounds \cref{eq:two_level_ASM_condition_bound_Nico,eq:two_level_ASM_condition_bound_DtN} are both robust to the scaling in the fine-mesh size, that is they do not contain the any terms depending on $h$. This is an important feature of the two-level Schwarz method.
